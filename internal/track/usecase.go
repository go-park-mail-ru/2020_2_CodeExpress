...
type TrackUsecase interface {
	...
	GetByArtistIdWithFav(artistId uint64, userId uint64) ([]*models.Track, *ErrorResponse)
	...
	GetByParamsWithFav(count uint64, from uint64, userId uint64) ([]*models.Track, *ErrorResponse)
